...
const PlayerDetailModal = ({ player, onClose }) => {
  ...
  const getPositionInfo = (position) => {
    if (!position) {
      return { name: "Unknown Position", color: "text-gray-400" };
    }
    ...
    return positionMap[position] || { name: position, color: "text-gray-400" };
  };
      ...
      <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden border border-white/20">
        ...
        <div className="relative bg-gradient-to-r from-red-950/50 to-red-900/50 p-6 border-b border-white/20">
          ...
          <div className="flex items-start space-x-6">
            ...
            {seasonStats.rating && seasonStats.rating > 0 && (
              <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 px-4 py-3 rounded-xl border border-yellow-500/30">
                <div className="text-center">
                  ...
                  <div className="text-xs text-yellow-300">Average Rating</div>
                </div>
              </div>
            )}
          </div>
